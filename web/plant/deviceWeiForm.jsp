...
<div class="layui-form layuimini-form">
    ...
    <div class="layui-form-item">
        <label class="layui-form-label">维护设备名称</label>
    ...
    <div class="layui-form-item">
        <label class="layui-form-label required" >预计维护时间</label>
        <div class="layui-input-block">
            <input type="text" name="time" id="time" lay-verify="required" lay-reqtext="不能为空" placeholder="请输入类别名称" value="" class="layui-input">
        </div>
    </div>
    <div class="layui-form-item">
        <label class="layui-form-label required" >维护人员</label>
        <div class="layui-input-block">
            <input type="text" name="weiname" id="weiname" lay-verify="required" lay-reqtext="不能为空" placeholder="请输入类别名称" value="" class="layui-input">
        </div>
    </div>
    <div class="layui-form-item">
        <label class="layui-form-label required" >人员联系方式</label>
        <div class="layui-input-block">
            <input type="text" name="weiphone" id="weiphone" lay-verify="required" lay-reqtext="不能为空" placeholder="请输入类别名称" value="" class="layui-input">
        </div>
    </div>
    ...
    layui.use(['form','layarea','laydate'], function () {
        ...
        form.on('submit(saveBtn)', function (data) {
            ...
            if (data.field.id == null || data.field.id == "") {
                url="/devicewei/save"  //如果id号为空，表明是添加动作
            }else{
                url="/devicewei/update"//如果id号有值，表明是修改动作
            }
            //发送修改信息到后台
            $.ajax({
                url: url,
