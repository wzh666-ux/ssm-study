    ...
    layui.use(['form', 'table'], function () {
        ...
        table.render({    //刷新表格数据
            ...
            cols: [[
                ...
                {field: 'name',  title: '学生名称', sort: true},
                {field: 'age',  title: '年龄', sort: true},
                {field: 'classes',  title: '班级', sort: true},
                {field: 'cert',  title: '身份证号', sort: true},
        ...
        table.on('toolbar(currentTableFilter)', function (obj) {//toolbar 表头里按钮的动作事件
            if (obj.event === 'add') {  // 监听添加操作
                var index = layer.open({
                    title: '<h1 style="text-align: center">添加学生</h1>',
                    type: 2,
                    shade: 0.2,
                    maxmin:true,
                    shadeClose: true,
                    area: ['50%', '75%'],
                    content: 'studentForm.jsp',
                });
        ...
        table.on('tool(currentTableFilter)', function (obj) { // tool 表格里的操作按钮的动作事件
            ...
            if (obj.event === 'edit') {
                ...
                var index = layer.open({
                    title: '<h1 style="text-align: center">编辑学生</h1>',
                    type: 2,
                    shade: 0.2,
                    maxmin:true,
                    shadeClose: true,
