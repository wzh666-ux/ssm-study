                ...
                <form class="layui-form layui-form-pane" action="">
                    <div class="layui-form-item">
                        <div class="layui-inline">
                            <label class="layui-form-label">监控仓库</label>
    ...
    layui.use(['form', 'table'], function () {
        ...
        table.render({    //刷新表格数据
            ...
            cols: [[
                ...
                {field: 'name',  title: '监控仓库', sort: true},
                {field: 'time',  title: '预计监控时间', sort: true},
                {field: 'weiname',  title: '管理员', sort: true},
                {field: 'weiphone',  title: '管理员联系方式', sort: true},
        ...
        table.on('toolbar(currentTableFilter)', function (obj) {//toolbar 表头里按钮的动作事件
            if (obj.event === 'add') {  // 监听添加操作
                ...
                var index = layer.open({
                    title: '<h1 style="text-align: center">添加监控信息</h1>',
                    type: 2,
                    shade: 0.2,
                    maxmin:true,
                    shadeClose: true,
                    area: ['50%', '75%'],
                    content: 'cheWeiForm.jsp',
                });
        ...
        table.on('tool(currentTableFilter)', function (obj) { // tool 表格里的操作按钮的动作事件
            ...
            if (obj.event === 'edit') {
                json = JSON.stringify(obj.data);
                var index = layer.open({
                    title: '<h1 style="text-align: center">编辑监控内容</h1>',
                    type: 2,
                    shade: 0.2,
                    maxmin:true,
                    shadeClose: true,
