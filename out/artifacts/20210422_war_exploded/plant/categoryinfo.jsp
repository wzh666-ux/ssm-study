    ...
    layui.use(['form', 'table'], function () {
        ...
        table.render({    //刷新表格数据
            ...
            cols: [[
                ...
                {field: 'cyno',  title: '类别编号', sort: true},
                {field: 'cyname',  title: '类别名称', sort: true},
        ...
        table.on('toolbar(currentTableFilter)', function (obj) {//toolbar 表头里按钮的动作事件
            if (obj.event === 'add') {  // 监听添加操作
                var index = layer.open({
                    title: '<h1 style="text-align: center">添加车辆类别</h1>',
                    type: 2,
                    shade: 0.2,
                    maxmin:true,
                    shadeClose: true,
                    area: ['50%', '75%'],
                    content: 'categoryForm.jsp',
                });
        ...
        table.on('tool(currentTableFilter)', function (obj) { // tool 表格里的操作按钮的动作事件
            ...
            if (obj.event === 'edit') {
                ...
                var index = layer.open({
                    title: '<h1 style="text-align: center">编辑车辆类别</h1>',
                    type: 2,
                    shade: 0.2,
                    maxmin:true,
                    shadeClose: true,
                    ...
                    success: function (o, index) {  //页面打开成功后执行的动作,回显数据到编辑页面
                        ...
                        body.find("#cyname").val(data.cyname);
