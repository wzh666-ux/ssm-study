...
<div class="layui-form layuimini-form">
    ...
    <div class="layui-form-item">
        <label class="layui-form-label required">设备类别名称</label>
        <div class="layui-input-block">
            <input type="text" name="name" id="name" lay-verify="required" lay-reqtext="不能为空" placeholder="请输入设备类别名称"
                   class="layui-input">
        </div>
    </div>
    <div class="layui-form-item">
    ...
    layui.use(['form'], function () {
        ...
        form.on('submit(saveBtn)', function (data) {
            ...
            if (data.field.id == null || data.field.id == "") {
                url="/devicetype/save"  //如果id号为空，表明是添加动作
            }else{
                url="/devicetype/update"//如果id号有值，表明是修改动作
            }
            //发送修改信息到后台
            $.ajax({
                url: url,
